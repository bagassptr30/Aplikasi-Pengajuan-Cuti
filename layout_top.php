...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online DPMPTSP Kab.Serang - <?php echo $pagedesc ?></title>

	<link href="LOGO_DPMPTSP_KAB.SERANG.png" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="LOGO_DPMPTSP_KAB.SERANG.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Dinas Penanaman Modal Dan Pelayanan Terpadu Satu Pintu Kabupaten Serang</strong></div>
				...
				<a class="navbar-brand visible-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>PT. </strong></div>
					<div class="clear-both"></div>
				</a>
			</div><!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>DPMPTSP Kab. Serang</b></h4>
